...
export default function TemplatesHero() {
  return (
    <section className="relative pt-40 pb-20 border-b border-gray-100 min-h-[45vh] flex items-center bg-white overflow-hidden select-none">
      ...
      {/* Abstract floating blueprint wireframe SVGs representing layouts */}
      <svg className="absolute right-[5%] top-20 w-72 h-44 opacity-[0.03] pointer-events-none hidden lg:block" viewBox="0 0 320 200" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="320" height="200" rx="8" fill="none" stroke="#000" strokeWidth="2" />
        ...
        <rect x="20" y="44" width="80" height="12" rx="2" fill="none" stroke="#000" strokeWidth="1" />
        <rect x="20" y="68" width="120" height="40" rx="4" fill="none" stroke="#ef4444" strokeWidth="1" strokeDasharray="3 3" />
        <rect x="160" y="68" width="140" height="110" rx="4" fill="none" stroke="#000" strokeWidth="1" />
      </svg>

      <svg className="absolute left-[5%] bottom-10 w-72 h-44 opacity-[0.02] pointer-events-none hidden lg:block" viewBox="0 0 320 200" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="320" height="200" rx="8" fill="none" stroke="#000" strokeWidth="1.5" />
        <line x1="0" y1="24" x2="320" y2="24" stroke="#000" strokeWidth="1" />
        <rect x="20" y="44" width="280" height="40" rx="4" fill="none" stroke="#000" strokeWidth="1" />
        <circle cx="50" cy="120" r="16" fill="none" stroke="#ef4444" strokeWidth="1" strokeDasharray="2 2" />
        <rect x="86" y="108" width="200" height="8" rx="2" fill="none" stroke="#000" strokeWidth="1" />
        <rect x="86" y="124" width="140" height="8" rx="2" fill="none" stroke="#000" strokeWidth="1" />
      </svg>
      ...
      <Container className="relative z-10 max-w-4xl text-center space-y-6">
        ...
        >
          <Layout className="w-3.5 h-3.5 text-red-600 animate-pulse" />
