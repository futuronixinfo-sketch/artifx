    ...
    return (
        <section className="py-32 bg-black border-t border-neutral-900 relative overflow-hidden select-none">
            ...
            <Container className="relative z-10 text-center">
                ...
                >
                    <span className="text-xs font-mono text-[#f95738] uppercase tracking-widest mb-4 block font-bold">[ 06 / AUTOMATION_INITIATIVE ]</span>

                    <h2 className="text-3xl md:text-5xl font-light tracking-tight text-white mb-6 leading-tight">
                        Identify where AI can <br />
                        <span className="italic text-[#f95738]" style={{ fontFamily: "Georgia, serif" }}>actually</span> help your operations.
                    </h2>

                    <p className="text-xs font-light text-neutral-400 mb-12 max-w-md mx-auto leading-relaxed">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        ...
                        <Button variant="outline" size="md" href="/contact" className="w-full sm:w-auto min-w-[200px] justify-center px-6">
                            Book Strategy Call
                            <Calendar className="ml-2 w-4 h-4 text-[#f95738]" />
                        </Button>
                    </div>

                    <div className="mt-12 flex flex-wrap justify-center gap-8 text-[10px] text-neutral-600 font-mono uppercase tracking-widest">
                        <span className="flex items-center gap-2">
                            <Lock className="w-3 h-3 text-[#f95738]" /> SECURE & PRIVATE
                        </span>
                        <span>•</span>
