            ...
            <Container>
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    <div className="lg:w-1/2 text-left">
                        <span className="text-xs font-mono text-[#f95738] uppercase tracking-widest mb-4 block font-bold">[ 03 / OPERATIONAL_PHILOSOPHY ]</span>
                        <h2 className="text-3xl md:text-5xl font-light tracking-tight text-white mb-6 leading-tight">
                            Our approach to <br />
                            <span className="italic text-[#f95738]" style={{ fontFamily: "Georgia, serif" }}>Machine Intelligence</span>.
                        </h2>
                        <p className="text-xs font-light text-neutral-400 leading-relaxed mb-8 max-w-md">
                    ...
                    <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6">
                        {points.map((point, idx) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="p-6 bg-neutral-950/40 border border-neutral-900 hover:border-emerald-500/30 transition-colors"
                                style={{ borderRadius: 0 }}
                            >
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-2.5 h-2.5 bg-emerald-500" style={{ borderRadius: 0 }} />
                                    <h3 className="text-xs font-mono uppercase tracking-wider font-bold text-white">{point.title}</h3>
                                </div>
                                <p className="text-xs font-light text-neutral-400 leading-relaxed pl-4 border-l border-neutral-900">
                                    {point.description}
                                </p>
                            </motion.div>
                        ))}
