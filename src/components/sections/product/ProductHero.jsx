    ...
    <section className="relative pt-36 pb-20 border-b-2 border-black min-h-[50vh] flex items-center bg-[#FAFAF8] overflow-hidden">
      ...
      <Container className="relative z-10 max-w-4xl text-center space-y-6">
        ...
        >
          ...
          <span className="text-xs font-black font-mono uppercase tracking-widest">Our Products</span>
        </motion.div>
        ...
        >
          Built from real <span className="text-red-600 underline decoration-4 underline-offset-4">problems</span>.
        </motion.h1>
