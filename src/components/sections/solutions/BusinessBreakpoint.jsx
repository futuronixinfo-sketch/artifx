...
export default function BusinessBreakpoint() {
    ...
    return (
        <section ref={containerRef} className="relative py-28 bg-black border-t border-neutral-900 overflow-hidden select-none">
            ...
            <Container className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <h2 className="text-4xl sm:text-5xl md:text-6xl font-light tracking-tight text-white leading-[1.1] mb-6">
                        When Businesses Start <br />
                        <span className="italic text-[#f95738]" style={{ fontFamily: "Georgia, serif" }}>breaking</span>
                    </h2>
                    <p className="text-sm text-neutral-400 font-light mb-8 max-w-md leading-relaxed">
                        {businessBreakpoint.description}
                    </p>
                    <div className="w-24 h-px bg-[#f95738]/50" />
                </motion.div>
                ...
                <div className="relative">
                    ...
                    <div className="space-y-12">
                        {businessBreakpoint.stages.map((stage, idx) => (
                            ...
                            >
                                <div className="w-12 h-12 bg-neutral-900 border border-neutral-800 flex flex-shrink-0 items-center justify-center z-10 relative">
                                    <div className={`w-3 h-3 ${idx === 0 ? 'bg-[#f95738]' : 'bg-neutral-600'}`} />
                                </div>
                                <div>
                                    <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-tight">{stage.title}</h3>
