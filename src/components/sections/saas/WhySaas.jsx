...
export default function WhySaas() {
    return (
        <section className="py-32 bg-gray-50 border-b border-gray-200 select-none">
            <Container className="max-w-4xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start text-left">
                    <div>
                        <span className="text-xs font-mono text-red-600 uppercase tracking-widest block font-bold mb-4">[ 02 / WHY_SAAS ]</span>
                        <motion.h2
                            initial={{ opacity: 0 }}
                        ...
                        >
                            Why we build <span className="italic gradient-text" style={{ fontFamily: "Georgia, serif" }}>SaaS</span>.
                        </motion.h2>
                    </div>
