...
export default function OpeningStatement() {
    return (
        <section className="relative pt-36 pb-20 border-t-2 border-black min-h-[50vh] flex items-center bg-[#FAFAF8] overflow-hidden">
            ...
            <Container className="relative z-10 max-w-4xl text-center space-y-6">
                ...
                >
                    ...
                    <span className="text-[10px] font-mono font-black uppercase tracking-widest">Our Philosophy</span>
                </motion.div>
                ...
                >
                    Businesses <span className="text-red-600 underline decoration-4 underline-offset-4">grow</span>, but their systems don&apos;t.
                </motion.h1>
